...
const TimeChallengeScreen = ({ navigation }) => {
  ...
  return (
    ...
    <LinearGradient colors={['#4facfe', '#00f2fe', '#00c6ff', '#0072ff']} style={styles.container}>
      {/* Title text*/}
      <View>
        <Text style={[styles.titleOne, { fontSize: titleFontSize }]}>Time</Text>
        <Text style={[styles.titleThree, { fontSize: titleFontSize }]}>Challenge</Text>
      ...
      <View style={[styles.innerContainer, {height: themeContainerHeight}, {width: themeContainerWidth}]}> 
        ...
        <TouchableOpacity 
          ...
          activeOpacity={1.0}
          onPress={() => navigation.navigate('TimeChallengeThemeOneScreen')}>  
        ...
        <TouchableOpacity 
          ...
          activeOpacity={1.0}
          onPress={() => navigation.navigate('TimeChallengeThemeTwoScreen')}>  
        ...
        <TouchableOpacity 
          ...
          activeOpacity={1.0}
          onPress={() => navigation.navigate('TimeChallengeThemeThreeScreen')}>  
